...
@section('content')
    <div style="text-align:left;">
        ...
        <div style="text-align:center; margin: 15px;">
            <a href="{{ asset('/docs/branch.pdf') }}" target="_blank" style="background-color: #00c0ef;border-color: #00acd6;border-radius: 3px;color: #fff;padding: 10px 16px;text-decoration: none;font-size: 18px;line-height: 1.3333333;">Voir mon planning</a><br/>
        </div>

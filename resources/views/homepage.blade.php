...
@section('bodycontent')
    ...
    <div class="row sponsor">
        <div class="text-center">
            <?php
                $sponsors = [];
                if ( Config::get('services.partners.ada') ) { $sponsors[] = [ 'link' => 'http://www.ada.fr/location-voiture-troyes.html', 'img' => asset("img/sponsors/ada.png"), 'alt' => 'ADA Location de véhicules' ]; }
                if ( Config::get('services.partners.damonte') ) { $sponsors[] = [ 'link' => 'http://www.yves-damonte.fr', 'img' => asset("img/sponsors/damonte.png"), 'alt' => 'Damonte Immobilier' ]; }
                if ( Config::get('services.partners.mgel') ) { $sponsors[] = [ 'link' => 'http://www.mgel.fr/', 'img' => asset("img/sponsors/mgel.png"), 'alt' => 'MGEL' ]; }
                if ( Config::get('services.partners.popeye') ) { $sponsors[] = [ 'link' => 'http://www.auto-ecole-popeye.fr/', 'img' => asset("img/sponsors/popeye-white-background.png"), 'alt' => 'Popeye auto-école' ]; }
                if ( Config::get('services.partners.beijaflore') ) { $sponsors[] = [ 'link' => 'https://www.beijaflore.com/fr/', 'img' => asset("img/sponsors/beijaflore-2019.png"), 'alt' => 'Beijaflore' ]; }
                shuffle($sponsors);
            ?>

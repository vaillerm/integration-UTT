        ...
        <div class="box-body">
            <div class="thumbnail col-lg-2">
                ...
                <p>
                    ...
                    Ils t'accompagnerons pendant toute ta semaine d'intégration, au cours des différents jeux et activités te seront proposés.<br/>
                ...
                <p>
                    Pour être sûr d'avoir un max de chance de marquer des points, commencer par faire les actions suivantes :
                <ul>
                    ...
                    <li>Inscrit toi au weekend pour terminé ton intégration en beauté !</li>
                <p>
                ...
                @if(Auth::user()->isChecked('team_disguise'))
                    <h4 id="question">Félécitation, tu as rejoint le groupe facebook de ton équipe et tu as fait ton déguisement !</h4>

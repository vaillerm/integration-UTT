                ...
                <tbody>
                    @forelse($validations_pending as $validation)
                        <tr>
                            ...
                            <td>
                                <form method="post" action={{ route("validation.accept", ["challengeId" => $validation->challenge_id, "teamId" => $validation->team_id]) }}><input class="btn btn-xs btn-primary" type="submit" value="Valider"></form>
                                <a href="{{ route("validation.refuseForm", ["challengeId" => $validation->challenge_id, "teamId"=> $validation->team_id]) }}"><button class="btn btn-xs btn-danger">Refuser (avec un motif)</button></a>
                            </td>
                        </tr>
                    @empty
                ...
                <tbody>
                    <tr>
                        @foreach($validations_treated as $validation)
                            ...
                            <td>
                                <form method="post" action={{ route("validation.reset", ["challengeId" => $validation->challenge_id, "teamId" => $validation->team_id]) }}><input class="btn btn-xs btn-warning" type="submit" value="Annuler dernière action"></form>
                            </td>
                    </tr>
                @endforeach
                </tbody>
